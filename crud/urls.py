...
urlpatterns = [
    ...
    url(r'^create6$', views.create6, name='create6'),
    url(r'^list6$', views.list6, name='list6'),
    url(r'^edit6/(?P<id>\d+)$', views.edit6, name='edit6'),
    url(r'^edit6/update6/(?P<id>\d+)$', views.update6, name='update6'),
    url(r'^delete6/(?P<id>\d+)$', views.delete6, name='delete6'),
